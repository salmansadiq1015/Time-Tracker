  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl border-amber-200">
        <DialogHeader>
          <DialogTitle className="text-2xl text-foreground">Manage Team</DialogTitle>
          <DialogDescription>Add or remove employees from {project.name}</DialogDescription>
        </DialogHeader>
                ...
                projectData.employees.map((emp: any) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="text-destructive hover:text-destructive hover:bg-red-50 flex-shrink-0"
                    >
